        ...
        <form class="login-form-uni" id="loginForm" action="{{ url('login2') }} ">
            ...
            <!-- STEP 1: MOBILE NUMBER -->
               <div id="stepMobile">
                ...
                <input type="tel" id="mobile" class="login-input-uni " placeholder="" inputmode="numeric" maxlength="9" pattern="[0-9]*">
            ...
            <div id="stepRegistration" class="hidden">
                ...
                <label for="mobile" class="login-label-uni" style="margin-bottom:30px">
                    ...
                    <span title="Fill this form to register as a new user">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <div class="inline-field" style="display: flex; gap: 10px; margin-bottom:0;">
                    <div style="flex: 1;">
                        ...
                        <span title="Please enter your first name">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                    ...
                    <div style="flex: 1;">
                        ...
                        <span title="Please enter your last name">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <div style="margin-bottom: 15px;">
                    <label for="email" class="login-label-uni">Email <span title="Please enter valid email">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <!-- District -->
                <div style="margin-bottom: 15px;">
                    <label for="district" class="login-label-uni">District <span title="Select your district from the list to continue">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <!-- Password -->
                <div style="margin-bottom: 15px;">
                    <label for="password" class="login-label-uni">Password <span title="Create a strong password (min 8 characters)">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"
                ...
                <!-- Confirm Password -->
                <div style="margin-bottom: 15px;">
                    <label for="confirm-password" class="login-label-uni">Confirm Password <span title="Re-enter your password for confirmation">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="none"
                             stroke="currentColor"

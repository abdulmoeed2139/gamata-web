    ...
    <div class="login-left-uni">
        ...
        <form class="login-form-uni" id="loginForm" action="{{url('login2')}}">
            ...
            <div id="stepMobile">
                ...
                <input type="text" id="mobile" class="login-input-uni" inputmode="numeric" maxlength="10" pattern="[0-9]*">
                <span id="mobileError" class="error-text hidden" style="margin-top:0; margin-bottom:14px;">Please enter a valid number</span>

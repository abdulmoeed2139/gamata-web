...
@php
    $steps = [
        [
            ...
            "desc" => "Plan your crops effectively with tailored insights, seasonal recommendations, and weather updates to maximize your yield."
        ],
        [
            "title" => "2. Buy High-Quality Produce",
            "desc" => "Explore a wide range of fresh, locally sourced products. Buy directly from trusted farmers with ease."
        ],
        [
            "title" => "3. Reach More Buyers",
            "desc" => "List your produce effortlessly and connect with potential buyers across the platform for better prices."
        ],
        [
            "title" => "4. Join the Farming Community",
            "desc" => "Share knowledge, discuss best practices, and connect with like-minded farmers in a supportive community space."
        ]
    ];
@endphp
...
<section class="sec-1">
    <div class="wrapper">
        <div class="col-1">
            ...
            <div class="desc">
                Gamata is your go-to platform to plan crops, trade produce, and connect with the farming community. Whether you're growing,
    ...
    <div class="wrapper">
        <div class="col-1">
            <div class="content">
                ...
                <div class="desc">
                    Empowering farmers and businesses through direct connections, Gamata simplifies the trading of fresh produce while fostering
                    growth and collaboration. By bridging the gap between farmers and buyers, the platform enables seamless transactions, enhances
        ...
        <div class="col-2">
            ...
            <div class="content">
                ...
                <div class="desc">
                    To bring lasting positive change by embracing sustainable practices and delivering innovative solutions. By prioritizing
                    environmental stewardship, social responsibility, and forward-thinking strategies, we aim to create a meaningful impact that
                        ...
                        <div class="item">
                            <div class="wrap">
                                ...
                                <div class="tel">
                                    ...
                                    <a href="tel:{{$location['phone']}}" class="number">{{$location['phone']}}</a>
                                </div>
                                <div class="mail">
                                    <div class="icon">
                                        <svg>
                                    ...
                                    <a href="mailto:{{$location['email']}}" class="email">{{$location['email']}}</a>
                                </div>
...
<section class="community-section">
    <div class="wrapper">
        <div class="col-1">
            ...
            <div class="common-desc">
            At Gamata.com, we are proud to connect farmers, consumers, and agricultural enthusiasts in a thriving online ecosystem.

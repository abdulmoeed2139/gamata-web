...
<div class="contact-wrapper-uni">
        ...
        <form class="login-form-uni" id="contactForm" action="" method="POST">
            ...
            <div id="Contactform">
                ...
                <button type="submit" class="auth-btn common-btn-1">
                    Submit <img src="{{ asset('assets/Images/iconn.png') }}" alt="Gamata Logo" class="login-logo-uni">
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="contact-right">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.9323793984013!2d79.8470804683254!3d6.898691103469264!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2595e3e2c9461%3A0x8d7c700bc3878693!2sMarine%20Drive%2C%20Colombo%2C%20Sri%20Lanka!5e0!3m2!1sen!2s!4v1756995201469!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
</div>
@endsection
